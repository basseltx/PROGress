...
if (isset($_GET["save_forms"])){
	if (isset($_POST["option100"])){
		header( "Location: ./clean.php?mrn=$mrnum") ;
			}
	unset($choice_array);
	...
	$choices = "$choice_array[1]|$choice_array[2]|$choice_array[5]|$choice_array[6]|$choice_array[7]|$choice_array[8]|$choice_array[9]|$choice_array[10]|$choice_array[11]|$choice_array[12]";
	//echo $choices;
	$mysqli = openMysqli();
...
<td><img src="./PROGress-logo.jpg" alt="PROGress"></td>
</tr>
</table>
<?php
If (isset($LOC)){
...
<tr><td >
<font face=\"Lucida Grande\"><h4>Select patient by MR number and first name:</h4></td>
...
<div id=\"wb_Form1\" style=\"font-family:Lucida Grande;font-size:24px;position:absolute;left:24px;top:150px;width:800px;height:600px;z-index:2;\">
...
<input type=\"submit\" id=\"Button1\" name=\"save_forms\" value=\"Save for later\" onclick=\"submitForm('./list4.php?save_forms=yes')\" style=\"position:absolute;left:120px;top:450px;width:160px;font-family:Lucida Grande;font-size:20px;height:36px;z-index:5;\">
<input type=\"submit\" id=\"Button2\" name=\"load_forms\" value=\"Go to pt. form\" onclick=\"submitForm('./createform3-c.php')\" style=\"position:absolute;left:320px;top:450px;width:160px;font-family:Lucida Grande;font-size:20px;height:36px;z-index:5;\">
...
<div style=\"text-align:left\">Select patient:</div>
</div>
</div>
...
<option value = '' >Select MRN|First Name</option>"
;
...
if ($result = $mysqli->query($query)) {
    ...
    if ($row['mrn_pt'] == $mrnum) {
     ...
     echo "<option value=\"".$row['mrn_pt']."|".$row['f_name']."|".$row['pt_age']."|".$row['pt_sex']."\" $select_flag >".$row['mrn_pt']."|".$row['f_name']."</option>";
	$n++;
	$select_flag = "";
    }
...
<div id='primarycare' style='font-family:Lucida Grande;font-size:24px;left:110px'>
<br>Select the patient entered forms needed:<br><br>";
...
echo "</div>";
echo "<div id='pediatric' style='display:$pedsdecision;font-family:Lucida Grande;font-size:24px;left:110px'>";
...
<table style='width:800px'>
<tr><td >
<font face=\"Lucida Grande\"><h4>Select your location of care:</h4></td>
<td 'style=text-align:right'><a href=\"http://progress.screenstepslive.com/s/9044/m/28403\" target='_blank'>PROGress Manual</a></td></tr></table>
<div id=\"wb_Form1\" style=\"font-family:Lucida Grande;font-size:24px;position:absolute;left:24px;top:150px;width:800px;height:500px;z-index:2;\">
