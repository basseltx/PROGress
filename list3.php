...
<input type=\"submit\" id=\"Button1\" name=\"save_forms\" value=\"Save for later\" onclick=\"submitForm('./list4.php?save_forms=yes')\" style=\"position:absolute;left:120px;top:450px;width:180px;font-family:Lucida Grande;font-size:20px;height:36px;z-index:5;\">
<input type=\"submit\" id=\"Button2\" name=\"load_forms\" value=\"Go to pt. form\" onclick=\"submitForm('./createform3-c.php')\" style=\"position:absolute;left:320px;top:450px;width:180px;font-family:Lucida Grande;font-size:20px;height:36px;z-index:5;\">
